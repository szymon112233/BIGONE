...
public class TextureTilingController : MonoBehaviour
{
    ...
    void UpdateTiling()
    {
        ...
        gameObject.GetComponent<UnityEngine.UI.Image>().material.mainTextureScale = new Vector2(planeSizeX * gameObject.transform.lossyScale.x / textureToMeshX, planeSizeZ * gameObject.transform.lossyScale.z / textureToMeshZ);
    }
}